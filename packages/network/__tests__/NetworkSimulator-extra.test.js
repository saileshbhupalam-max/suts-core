...
const NetworkSimulator_1 = require("../src/NetworkSimulator");
describe('NetworkSimulator - Additional Coverage', () => {
    let simulator;
    beforeEach(() => {
        simulator = new NetworkSimulator_1.NetworkSimulator();
    });
    const createMockPersona = (id) => ({
        id,
        archetype: 'test',
        role: 'Developer',
    ...
    const createMockEvents = (personaId, delight = 0.9) => [
        {
    ...
    describe('synthetic data generation', () => {
        it('should generate synthetic events for referred users', () => {
            const highRefSimulator = new NetworkSimulator_1.NetworkSimulator({
    ...
    describe('predictGrowth - edge cases', () => {
        ...
        it('should handle very high churn rate', () => {
            const highChurnSimulator = new NetworkSimulator_1.NetworkSimulator({
                dailyChurnRate: 0.15,
...
//# sourceMappingURL=NetworkSimulator-extra.test.js.map