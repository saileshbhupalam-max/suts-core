...
const TokenCounter_1 = require("../src/features/TokenCounter");
const ContextPreview_1 = require("../src/features/ContextPreview");
const TryMode_1 = require("../src/features/TryMode");
const Dashboard_1 = require("../src/features/Dashboard");
const PersistentMemory_1 = require("../src/features/PersistentMemory");
const PerformanceOpt_1 = require("../src/features/PerformanceOpt");
const AutoCapture_1 = require("../src/features/AutoCapture");
const SessionReports_1 = require("../src/features/SessionReports");
const MCPServer_1 = require("../src/features/MCPServer");
...
describe('TokenCounterFeature', () => {
    ...
    let persona;
    beforeEach(() => {
        feature = new TokenCounter_1.TokenCounterFeature();
...
describe('ContextPreviewFeature', () => {
    ...
    let persona;
    beforeEach(() => {
        feature = new ContextPreview_1.ContextPreviewFeature();
        state = createMockState();
...
describe('TryModeFeature', () => {
    ...
    let persona;
    beforeEach(() => {
        feature = new TryMode_1.TryModeFeature();
        state = createMockState();
    ...
    it('should expire try mode when days reach zero', () => {
        ...
        state.tokenCounter.savingsPercent = 50;
        const action = {
            type: core_1.ActionType.USE_FEATURE,
            feature: 'tryMode',
            description: 'day elapsed',
...
describe('DashboardFeature', () => {
    ...
    let persona;
    beforeEach(() => {
        feature = new Dashboard_1.DashboardFeature();
        state = createMockState();
    ...
    it('should return share action only when savings are high', () => {
        ...
        const actions = feature.getAvailableActions(state, persona);
        const shareAction = actions.find(a => a.type === core_1.ActionType.SHARE);
...
describe('PersistentMemoryFeature', () => {
    ...
    let persona;
    beforeEach(() => {
        feature = new PersistentMemory_1.PersistentMemoryFeature();
        state = createMockState();
...
describe('PerformanceOptFeature', () => {
    ...
    let persona;
    beforeEach(() => {
        feature = new PerformanceOpt_1.PerformanceOptFeature();
        state = createMockState();
    ...
    it('should handle optimize action', () => {
        ...
        const newState = feature.applyAction(state, action, persona);
        expect(newState.performance.avgResponseTime).toBeLessThan(state.performance.avgResponseTime);
    });
    it('should upgrade optimization level', () => {
        state.performance.optimizationLevel = 'low';
        const action = {
            type: core_1.ActionType.USE_FEATURE,
            feature: 'performanceOpt',
        ...
        const newState = feature.applyAction(state, action, persona);
        expect(newState.performance.optimizationLevel).toBe('medium');
    });
...
describe('AutoCaptureFeature', () => {
    ...
    let persona;
    beforeEach(() => {
        feature = new AutoCapture_1.AutoCaptureFeature();
        state = createMockState();
        persona = createMockPersona();
    });
    it('should have correct name', () => {
...
describe('SessionReportsFeature', () => {
    ...
    let persona;
    beforeEach(() => {
        feature = new SessionReports_1.SessionReportsFeature();
        state = createMockState();
...
describe('MCPServerFeature', () => {
    ...
    let persona;
    beforeEach(() => {
        feature = new MCPServer_1.MCPServerFeature();
        state = createMockState();
