...
describe('Pipeline Hooks', () => {
  ...
  describe('createProgressHook', () => {
    ...
    it('should log pipeline start', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('Pipeline started at'));
    });
    ...
    it('should log stage error', async () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith('❌ Stage test-stage failed:', 'Test error');
    });
