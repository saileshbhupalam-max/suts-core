...
export class ThemeExtractor {
   ...
   */
  private buildThemes(rawThemes: readonly RawThemeExtraction[]): ExtractedTheme[] {
  ...
  private getMostCommonCategory(
    group: readonly RawThemeExtraction[]
  ): RawThemeExtraction['category'] {
    ...
    let maxCategory: RawThemeExtraction['category'] =
      firstItem !== undefined ? firstItem.category : 'pain';
    let maxCount = 0;
